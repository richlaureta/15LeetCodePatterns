...
def isValidSudoku(board: list[list[str]]) -> bool:
    ...
    for index in range(len(board)):
        ...
        for index1 in range(len(board[0])):
            if board[index][index1] == ".":
                continue
            
            if board[index][index1] in numberSeenRow:
                return False
            else:
